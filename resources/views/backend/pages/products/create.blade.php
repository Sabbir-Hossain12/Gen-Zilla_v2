            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.product.create') }}">Add Product</a></li>
                    </ol>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="initial_stock" min="0"
                                               placeholder="Product Name"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body  accordion-collapse collapse" id="collapseTwo">
                            ...
                            <div class="row">
                                <div class="col-lg-8 mb-3">
                                    ...
                                    <img class="mt-2" id="newImg1"
                                         src="{{asset('backend/assets/images/placeholder.jpg')}}" height="160px">
                                </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea class="form-control" name="youtube_embed_link" id="youtube_embed_link"
