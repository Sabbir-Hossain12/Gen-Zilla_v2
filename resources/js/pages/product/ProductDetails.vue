  ...
  <div class="max-w-7xl mx-auto px-4 pb-10">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <div class="md:col-span-4 bg-white border border-gray-100 rounded-lg p-4">
        <div class="relative flex items-center justify-center bg-white rounded-lg h-72 overflow-hidden">
          <img id="mainImg"
               src="https://d2t8nl1y0ie1km.cloudfront.net/images/thumbs/65fa961e115075f231ecce6b_Radhuni-Shadmishali-Seasoning-Mixed-96gm_1_415.webp"
               class="object-contain h-full w-full" alt="ACI Pure Puffed Rice"/>
          <button class="absolute bottom-3 right-3 bg-white border border-gray-200 rounded-full w-8 h-8 flex items-center justify-center text-gray-500 hover:text-[#E8312A] shadow-sm">
      ...
      <div class="md:col-span-5 bg-white border border-gray-100 rounded-lg p-5 flex flex-col gap-4">
        <h1 class="text-xl font-bold text-gray-800 leading-snug">ACI Pure Puffed Rice 500gm</h1>

        <div class="flex items-baseline gap-2">
          <span class="text-[#E8312A] text-3xl font-bold">৳75</span>
          <span class="text-gray-500 text-sm">Per Piece</span>
        </div>

        <button class="bg-[#E8312A] hover:bg-[#C4251F] text-white font-semibold rounded-full px-8 py-2.5 flex items-center gap-2 w-fit transition-colors duration-200">
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2">
            <span class="border border-gray-300 rounded px-2.5 py-1 text-[13px] text-gray-600">Local Snacks</span>
            <span class="border border-gray-300 rounded px-2.5 py-1 text-[13px] text-gray-600">Traditional Snacks</span>
            <span class="border border-gray-300 rounded px-2.5 py-1 text-[13px] text-gray-600">Locally-Made Snacks</span>
            <span class="border border-gray-300 rounded px-2.5 py-1 text-[13px] text-gray-600">Specialty Snacks</span>
          </div>
        </div>
      </div>
      ...
      <div class="md:col-span-3 flex flex-col gap-4">
        ...
        <div class="bg-white border border-gray-100 rounded-lg p-4 flex flex-col gap-3">
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600"><span class="font-semibold">SKU:</span> 2812693</span>
          ...
          <div class="text-sm text-gray-600">
            ...
            <a href="#" class="text-[#E8312A] hover:underline font-medium">ACI Pure</a>
          </div>

          <p class="text-sm text-gray-600 leading-relaxed">500gm- Crispy, light, and ready for your favorite snacks.</p>

          <hr class="border-gray-100"/>

          <div class="flex items-center gap-3 flex-wrap">
            <button class="flex items-center gap-1.5 border border-gray-200 rounded-full px-3 py-1.5 text-sm text-gray-600 hover:border-[#E8312A] hover:text-[#E8312A] transition-colors">
              <i class="fa-regular fa-heart text-sm"></i>
              <span>Add to Wishlist</span>
            </button>
            <div class="flex items-center gap-2">
              <a href="#" class="w-8 h-8 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center text-white transition-colors">
                <i class="fa-brands fa-facebook-f text-xs"></i>
              </a>
              <a href="#" class="w-8 h-8 rounded-full bg-blue-500 hover:bg-blue-600 flex items-center justify-center text-white transition-colors">
                <i class="fa-brands fa-facebook-messenger text-xs"></i>
              </a>
              <a href="#" class="w-8 h-8 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center text-white transition-colors">
    ...
    <div class="mt-8 bg-white border border-gray-100 rounded-lg overflow-hidden">
      <div class="p-4 border-b border-gray-100">
        <button class="bg-[#F5C518] text-black font-semibold px-5 py-1.5 rounded-full text-sm">Reviews</button>
      </div>
